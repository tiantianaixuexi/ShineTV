...
- 🟡 **V9/V10/V11 影视化链**：**S23 已做 V9**（`NarrativeShot[]` → `shots`，K22/K24 的数据源）、**S24 已做 V10**（九层组装 → `PromptArtifact` 账，K23 的受检对象）；**未做**：**V11 出图接线**（含 **K19–K21 回填** —— `ToGenShot` 已实现但**仍只有自检调用**）、V1–V8 逐步展开
